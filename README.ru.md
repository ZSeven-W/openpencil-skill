...
- Справочник команд CLI `op` (app control, document ops, nodes, import, export, templates, layout, pages, variables, codegen)
- Пакетный DSL дизайна и изолированный режим JavaScript с полными примерами
- Схема PenNode — все типы узлов v0.8.4, включая интерактивные виджеты, свойства и заливки
...
- Поддержка импорта (SVG, HTML-страницы и живые URL, веб-снимки, файлы Figma .fig)
- Экспорт и передача — изображения, PDF и презентации (PowerPoint, автономный HTML)
- Шаблоны сцен и стилевые ресурсы, включая импортированные вами руководства DESIGN.md
